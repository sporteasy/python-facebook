...
class FacebookResponseTest(PythonFacebookTestCase):
    ...
    def testAProperAppSecretProofCanBeGenerated(self):
        ...
        self.assertEqual('df4256903ba4e23636cc142117aa632133d75c642bd2a68955be1443bd14deb9', appSecretProof)
    ...
    def testASuccessfulJsonResponseWillBeDecodedToAGraphNode(self):
        ...
        self.assertFalse(response.is_error(), 'Did not expect Response to return an error.')
        self.assertEqual({
            'id': '123',
            'name': 'Foo',
        }, decodedResponse)
    ...
    def testASuccessfulUrlEncodedKeyValuePairResponseWillBeDecoded(self):
        ...
        response = FacebookResponse(self.request, graphResponseKeyValuePairs, 200)
        decodedResponse = response.get_decoded_body()
        self.assertFalse(response.is_error(), 'Did not expect Response to return an error.')
        self.assertEqual({
            'id': '123',
    ...
    def testErrorStatusCanBeCheckedWhenAnErrorResponseIsReturned(self):
        ...
        self.assertTrue(response.is_error(), 'Expected Response to return an error.')
