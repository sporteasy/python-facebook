...
class RequestBodyMultipartTest(PythonFacebookTestCase):
    ...
    def testCanProperlyEncodeAnArrayOfParams(self):
        ...
        self.assertEqual(sorted(expected_body.split('--foo_boundary')),
                         sorted(body.split('--foo_boundary')))
    ...
    def testCanProperlyEncodeFilesAndParams(self):
        ...
        # body = message.get_body()
        # expected_body = "--foo_boundary\r\n"
        # expected_body += "Content-Disposition: form-data
        # name=\"foo\"\r\n\r\nbar\r\n"
        # expected_body += "--foo_boundary\r\n"
        # expected_body += "Content-Disposition: form-data
        # name=\"foo_file\" filename=\"foo.txt\"\r\n"
    ...
    def testSupportsMultidimensionalParams(self):
        ...
        expected_body = "--foo_boundary\r\n" \
                        ...
                        "--foo_boundary\r\n" \
                        "Content-Disposition: form-data; " \
                        "name=\"call_to_action[value][link]" \
                        "\"\r\n\r\nhttp://example.com\r\n" \
                        "--foo_boundary\r\n" \
                        "Content-Disposition: form-data; " \
                        "name=\"call_to_action[value][sponsorship][image]" \
